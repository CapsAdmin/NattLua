...
function shared.Get(a--[[#: TBaseType]], key--[[#: TBaseType]])
	Nil = Nil or require("nattlua.types.symbol").Nil
	Union = Union or require("nattlua.types.union").Union
	LNumber = LNumber or require("nattlua.types.number").LNumber
	Any = Any or require("nattlua.types.any").Any
	...
	if a.Type == "any" then return a end
	...
	return false, error_messages.undefined_get(a, key, a.Type)
end

function shared.Set(a--[[#: TBaseType]], key--[[#: TBaseType]], val--[[#: TBaseType]], no_delete)
	if a.Type == "deferred" then
		local unwrapped = a:Unwrap()
	...
	return false, error_messages.undefined_set(a, key, val, a.Type)
end
