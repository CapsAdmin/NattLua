...
function types.Initialize()
    types.Union = require("nattlua.typesystem.union")
    types.Table = require("nattlua.typesystem.table")
    types.List = require("nattlua.typesystem.list")
    types.Tuple = require("nattlua.typesystem.tuple")
    types.Number = require("nattlua.typesystem.number")
    types.Function = require("nattlua.typesystem.function")
    types.String = require("nattlua.typesystem.string")
    types.Any = require("nattlua.typesystem.any")
    types.Symbol = require("nattlua.typesystem.symbol")
    types.Never = require("nattlua.typesystem.never")
    types.Error = require("nattlua.typesystem.error")
