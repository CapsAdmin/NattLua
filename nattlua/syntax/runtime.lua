...
runtime:AddNumberAnnotations{"ull", "ll", "ul", "i",}
runtime:AddKeywords{
	"do",
	"end",
	"if",
...
runtime:AddNonStandardKeywords{"continue", "import", "literal", "mutable", "goto"}
runtime:AddKeywordValues{"...", "nil", "true", "false",}
...
runtime:AddPrefixOperatorFunctionTranslate{["~"] = "bit.bnot(A)",}
