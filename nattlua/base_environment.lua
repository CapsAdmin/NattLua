...
local function seed_bundle_bootstrap_globals(env)
	...
	package_value:Set(LStringNoMeta("config"), Any())
	package_value:Set(LStringNoMeta("path"), Any())
	package_value:Set(LStringNoMeta("cpath"), Any())
	package_value:Set(LStringNoMeta("searchers"), Any())
	package_value:Set(LStringNoMeta("loaders"), Any())
	package_value:Set(LStringNoMeta("searchpath"), Any())
