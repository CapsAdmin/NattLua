...
do
	...
	arr:Set(5, 777)
	assert(#arr == 10)
	assert(arr:GetWithNumber(5) == 777)
	...
	assert(view_slice:GetWithNumber(1) == 2)
	assert(view_slice:GetWithNumber(2) == 3)
	view_slice:Set(1, 666)
	assert(view_slice:GetWithNumber(1) == 666)
	assert(arr:GetWithNumber(6) == 666)
	local slice = arr:Slice(5, 7)
	assert(slice:Get(0) == 1)
	assert(slice:GetWithNumber(1) == 666)
	assert(slice:GetWithNumber(2) == 3)
	slice:Set(1, 2)
	assert(slice:GetWithNumber(1) == 2)
	assert(view_slice:GetWithNumber(1) == 666)
	local UInt8Array10 = StaticArrayType(u8, 10)
	local arr = UInt8Array10()
	assert(#arr == 10)
	arr:Set(5, 44)
	assert(arr:GetWithNumber(5) == 44)
end
