...
analyze[[
    local test = ReturnIfNonLiteral<|analyzer function(foo: number): number
        return 1
    end|>
...
analyze[[
    local test = ReturnIfNonLiteral<|analyzer function(foo: number)
        return 1, 2
    end|>
...
analyze[[
attest.equal(bit.tohex(_ as -65536 | 0 .. 255), _ as  "00000000" | "000000ff" | "ffff0000" | string)
]]
analyze[[
