...
return {
	Union = function(...)
		return types.Union(cast(...))
	end,
	Tuple = function(...)
		return types.Tuple(cast(...))
	end,
	Number = function(n)
		return types.Number(n):SetLiteral(n ~= nil)
	end,
	Function = function(d)
		return types.Function(d)
	end,
	String = function(n)
		return types.String(n):SetLiteral(n ~= nil)
	end,
	Table = function(data)
		return types.Table(data or {})
	end,
	Symbol = function(data)
		return types.Symbol(data)
	end,
	Any = function()
		return types.Any()
	end,
