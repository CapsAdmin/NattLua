...
IMPORTS['nattlua/transpiler/emitter.lua'] = function(...) local runtime_syntax = IMPORTS['nattlua.syntax.runtime']("nattlua.syntax.runtime")
local characters = IMPORTS['nattlua.syntax.characters']("nattlua.syntax.characters")
local print = _G.print
local error = _G.error
local debug = _G.debug
...
return META end
do local __M; IMPORTS["nattlua.transpiler.javascript_emitter"] = function(...) __M = __M or (function(...) local runtime_syntax = IMPORTS['nattlua.syntax.runtime']("nattlua.syntax.runtime")
local ipairs = ipairs
local assert = assert
